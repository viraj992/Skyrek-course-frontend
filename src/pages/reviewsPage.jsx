        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 transform transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Submit Review
            </button>
          </div>
